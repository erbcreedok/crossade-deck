...
export const PALETTE = {
  ...
  gold: "#f2c14e",
  /**
   * ЗОЛОТО ЛИТОЙ КНОПКИ — верх и низ её отлива. Кнопка не плоская: она выпуклая, и выпуклость —
   * это два конца одного золота, а не второй цвет. Оба живут здесь по тому же закону, что и всё
   * остальное: одно место держит цвета.
   */
  goldLight: "#f8d885",
  goldDark: "#b08a26",
  /** Alarm. */
  danger: "#e0483f",
  /**
   * ТРЕВОЖНЫЙ В КНОПКЕ — приглушённый, двумя концами отлива. Тот же `danger` во всю кнопку кричал
   * бы громче надписи на ней: «закрыть комнату» — не авария, а решение, и выглядеть оно должно
   * тяжёлым, а не аварийным.
   */
  dangerDim: "#8c2f2a",
  dangerDark: "#5c1d19",
