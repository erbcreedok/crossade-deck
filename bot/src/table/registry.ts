...
export interface Known {
  ...
  title: string;
  /**
   * РОД СТОЛА. Тоже обязан пережить перезапуск: без него крестовая комната возвращается песочницей —
   * с той же ссылкой и тем же именем, но без круга хода и без правил, по которым в ней играли.
   */
  kind?: string;
}
