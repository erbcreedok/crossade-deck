    ...
    options: {
      ...
      storySort: {
        order: [
          ...
          ["Node", "Root"],
          "Atoms",
          ["Bounded", "Surfaced", "Coated", "Transformable", "Container", "Flippable", "Tiltable", "Draggable", "Grippable", "Private", "ShadowCaster", "Lit", "Inviting", "Valued", "Owned", "Labeled", "Placeable"],
