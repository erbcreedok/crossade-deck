    ...
    options: {
      ...
      storySort: {
        order: [
          ...
          ["Node", "Root"],
          "Atoms",
          ["Bounded", "Surfaced", "Coated", "Transformable", "Container", "Flippable", "Tiltable"],
          ...
          "Presets",
          ["Bounds", "Surfaces", "Poses", "Layouts", "Components"],
          "Engine",
          ...
          "Tests",
          ["Node", "Bounded", "Surfaced", "Transformable", "Container", "Tiltable"],
        ],
      },
    },
  },
