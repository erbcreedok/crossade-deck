...
| `flip.facing-inspector` ⏳ | `facing(id)` | инспектор | «какой стороной сейчас» читается без пересчёта руками (этап 6) |
| `flip.flip-action-bumps-turns` ⏳ | глагол flip | обработчик | turns+1 на узле — и больше ничего (этап 6) |
