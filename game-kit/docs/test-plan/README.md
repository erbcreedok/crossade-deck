...
**77 слоёв · 1648 кейсов заявлено · 1475 расписано поимённо.**
...
| [UNIT · live — дальний экран и люди за столом](67-live.md) | `vitest (headless, no WebGL) + jsdom` | 6 | 6 |
...
| [UNIT · liveTable — живой стол целиком](78-live-table.md) | `vitest + jsdom + фейковые часы` | 11 | 11 |
