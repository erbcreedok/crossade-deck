...
**79 слоёв · 1730 кейсов заявлено · 1557 расписано поимённо.**
...
| [UNIT · per-atom contract](08-per-atom-contract.md) | `vitest` | 109 | 109 |
| [UNIT · Container — slot, layout, spreading](09-container.md) | `vitest` | 107 | 95 |
| [UNIT · the scene plan](10-scene-plan.md) | `vitest (headless, no WebGL)` | 75 | 75 |
...
| [LIFECYCLE & PERFORMANCE](22-lifecycle-and-performance.md) | `vitest + a headless Pixi fake` | 24 | 13 |
...
| [UNIT · AcceptRule — the zone's predicate](26-accept.md) | `vitest` | 21 | 21 |
...
| [UNIT · motion — the settle clock](40-motion.md) | `vitest + a fake clock` | 55 | 55 |
...
| [UNIT · launch и slide — баллистика на одних часах](46-launch-and-slide.md) | `vitest + a fake clock` | 24 | 24 |
...
| [UNIT · контролы — `Pressable`, пресет `button`, проводка](50-controls.md) | `vitest` | 33 | 33 |
| [UNIT · пыль цензуры — облако без единого пикселя](51-censor-dust.md) | `vitest (headless, no WebGL)` | 21 | 21 |
| [UNIT · камера — как на холст смотрят](52-camera.md) | `vitest (headless, no renderer)` | 41 | 41 |
| [UNIT · руки на столе — жесты камеры и арбитраж](53-camera-input.md) | `vitest (headless, no renderer)` | 18 | 18 |
...
| [UNIT · fall — бросок, падение и посадка](71-fall.md) | `vitest` | 13 | 13 |
| [UNIT · landing — картинка приземления](72-landing.md) | `vitest` | 9 | 9 |
...
| [UNIT · liveTable — живой стол целиком](78-live-table.md) | `vitest + jsdom + фейковые часы` | 29 | 29 |
| [UNIT · HUD камеры — три кнопки в углу](79-camera-hud.md) | `vitest + jsdom` | 8 | 8 |
