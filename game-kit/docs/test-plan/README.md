...
**67 слоёв · 1516 кейсов заявлено · 1343 расписано поимённо.**
...
| [UNIT · оболочка каталога](11-catalog-shell.md) | `vitest + jsdom` | 69 | 69 |
...
| [UNIT · motion — the settle clock](40-motion.md) | `vitest + a fake clock` | 41 | 41 |
...
| [UNIT · отпускание — что дроп НЕ имеет права менять](63-drag-drop-order.md) | `vitest` | 7 | 7 |
