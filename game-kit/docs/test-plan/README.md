...
**67 слоёв · 1527 кейсов заявлено · 1354 расписано поимённо.**
...
| [UNIT · оболочка каталога](11-catalog-shell.md) | `vitest + jsdom` | 92 | 92 |
...
| [UNIT · магнетизм — какой зоне принадлежит отпускание](66-magnetism.md) | `vitest (headless, no WebGL)` | 18 | 18 |
