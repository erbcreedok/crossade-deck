...
**77 слоёв · 1666 кейсов заявлено · 1493 расписано поимённо.**
...
| [UNIT · камера — как на холст смотрят](52-camera.md) | `vitest (headless, no renderer)` | 29 | 29 |
...
| [UNIT · liveTable — живой стол целиком](78-live-table.md) | `vitest + jsdom + фейковые часы` | 13 | 13 |
