...
**57 слоёв · 1329 кейсов заявлено · 1156 расписано поимённо.**
...
| [INTERACTION · play functions](16-interaction-play.md) | `@storybook/test + userEvent, Vitest browser mode` | 105 | 100 |
...
| [CATALOG · локальный мастер — семантика доставки](57-local-master.md) | `vitest + фейковые таймеры` | 12 | 12 |
