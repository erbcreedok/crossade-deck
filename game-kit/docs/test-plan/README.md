...
**63 слоёв · 1481 кейсов заявлено · 1308 расписано поимённо.**
...
| [UNIT · оболочка каталога](11-catalog-shell.md) | `vitest + jsdom` | 89 | 89 |
...
| [UNIT · motion — the settle clock](40-motion.md) | `vitest + a fake clock` | 45 | 45 |
