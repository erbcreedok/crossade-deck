...
**61 слоёв · 1413 кейсов заявлено · 1240 расписано поимённо.**
...
| [ARCHITECTURAL GUARDS · source-scan](15-architectural-guards.md) | `vitest + fs scan (like argNames.test.ts)` | 34 | 34 |
