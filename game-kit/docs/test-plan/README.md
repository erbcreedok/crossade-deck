...
**53 слоя · 1247 кейсов заявлено · 1074 расписано поимённо.**
...
| [UNIT · motion — the settle clock](40-motion.md) | `vitest + a fake clock` | 27 | 27 |
| [UNIT · pointer — glass, units and the pick](41-input.md) | `vitest (headless, no WebGL)` | 8 | 8 |
