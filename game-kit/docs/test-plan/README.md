...
**49 слоёв · 1107 кейсов заявлено · 934 расписано поимённо.**
...
| [ARCHITECTURAL GUARDS · source-scan](15-architectural-guards.md) | `vitest + fs scan (like argNames.test.ts)` | 31 | 31 |
