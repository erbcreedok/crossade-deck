...
**25 слоя · 720 кейсов заявлено · 545 расписано поимённо.**
...
| [UNIT · Container — slot, layout, spreading](09-container.md) | `vitest` | 60 | 54 |
...
| [INTERACTION · play functions](16-interaction-play.md) | `@storybook/test + userEvent, Vitest browser mode` | 60 | 49 |
