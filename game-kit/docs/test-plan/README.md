...
**67 слоёв · 1525 кейсов заявлено · 1352 расписано поимённо.**
...
| [UNIT · оболочка каталога](11-catalog-shell.md) | `vitest + jsdom` | 90 | 90 |
...
| [UNIT · motion — the settle clock](40-motion.md) | `vitest + a fake clock` | 46 | 46 |
...
| [UNIT · магнетизм — какой зоне принадлежит отпускание](66-magnetism.md) | `vitest (headless, no WebGL)` | 17 | 17 |
| [UNIT · live — что один экран рисует о чужих руках](67-live.md) | `vitest (headless, no WebGL)` | 4 | 4 |
