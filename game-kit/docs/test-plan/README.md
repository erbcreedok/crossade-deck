...
**79 слоёв · 1718 кейсов заявлено · 1545 расписано поимённо.**
...
| [UNIT · motion — the settle clock](40-motion.md) | `vitest + a fake clock` | 54 | 54 |
...
| [UNIT · камера — как на холст смотрят](52-camera.md) | `vitest (headless, no renderer)` | 35 | 35 |
| [UNIT · руки на столе — жесты камеры и арбитраж](53-camera-input.md) | `vitest (headless, no renderer)` | 16 | 16 |
