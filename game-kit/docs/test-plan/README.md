...
**63 слоёв · 1473 кейсов заявлено · 1300 расписано поимённо.**
...
| [UNIT · оболочка каталога](11-catalog-shell.md) | `vitest + jsdom` | 82 | 82 |
...
| [UNIT · motion — the settle clock](40-motion.md) | `vitest + a fake clock` | 44 | 44 |
