...
**25 слоя · 775 кейсов заявлено · 594 расписано поимённо.**
...
| [UNIT · Container — slot, layout, spreading](09-container.md) | `vitest` | 102 | 90 |
...
| [INTERACTION · play functions](16-interaction-play.md) | `@storybook/test + userEvent, Vitest browser mode` | 73 | 62 |
