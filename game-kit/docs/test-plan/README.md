...
**78 слоёв · 1685 кейсов заявлено · 1512 расписано поимённо.**
...
| [UNIT · оболочка каталога](11-catalog-shell.md) | `vitest + jsdom` | 110 | 109 |
...
| [UNIT · live — дальний экран и люди за столом](67-live.md) | `vitest (headless, no WebGL) + jsdom` | 9 | 9 |
...
| [UNIT · landing — картинка приземления](72-landing.md) | `vitest` | 7 | 7 |
...
| [UNIT · liveTable — живой стол целиком](78-live-table.md) | `vitest + jsdom + фейковые часы` | 17 | 17 |
