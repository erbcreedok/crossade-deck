...
**53 слоя · 1234 кейсов заявлено · 1061 расписано поимённо.**
...
| [UNIT · the scene plan](10-scene-plan.md) | `vitest (headless, no WebGL)` | 57 | 57 |
...
| [ARCHITECTURAL GUARDS · source-scan](15-architectural-guards.md) | `vitest + fs scan (like argNames.test.ts)` | 32 | 32 |
| [INTERACTION · play functions](16-interaction-play.md) | `@storybook/test + userEvent, Vitest browser mode` | 100 | 95 |
...
| [UNIT · motion — the settle clock](40-motion.md) | `vitest + a fake clock` | 23 | 23 |
...
| [UNIT · тасовка и кувырок — истина, случай, хореография](47-shuffle-and-roll.md) | `vitest + a fake clock` | 12 | 12 |
