...
#
# Адрес игрового сервера вшивается в v1-бандл на этапе сборки — передаётся build-аргументами
# (VITE_SERVER_URL/VITE_HTTP_URL из client/fly.toml). Номер сборки/коммит — APP_BUILD/APP_COMMIT.
