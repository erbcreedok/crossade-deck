...
/** Раскладка карт руки: ряд с нахлёстом (дефолт) или веер дугой. Данные — крутит игрок/дизайнер. */
...
export interface HandSpec {
  reorder: boolean;
  /** Раскладка карт руки. Нет поля — «row» (прежнее поведение). */
  layout?: HandLayout;
  /** Где живёт рука. Нет поля — «board»: рука сидит зоной в дереве борды, как раньше. «screen» —
   *  HUD во всю ширину снизу, фикс к камере, вне контентных координат (не зумится, не ездит паном). */
