...
export interface ZoneSpec {
  ...
  hidden?: boolean;
  /** ПРИВАТНОСТЬ ДОСТУПА (strip-зоны): чужие не трогают экземпляры зоны и их жителей. Нет поля —
   *  у strip true; false — общая лента (валидирует порт, жест лишь отражает). */
  locked?: boolean;
