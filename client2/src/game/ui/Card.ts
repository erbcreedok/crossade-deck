...
//   lifted — парит (тень дальше/крупнее, слегка больше, покачивается в воздухе — bob);
...
export interface CardOptions {
   ...
   *
   * Не то же, что план покоя: план — это роль («её держат»), а `z` — число, которым высоту можно
...
export class Card implements TableElement, Draggable, Flippable, Burnable, Concealable, Peekable, Valued {
  ...
  sync(): void {
    ...
    // ВЫСОТА — один источник: план покоя (масштаб) плюс дыхание. Из неё выводится и подъём
    ...
    // Высота: план покоя плюс подъём полёта. Полёт даёт её в пикселях — переводим в доли высоты
