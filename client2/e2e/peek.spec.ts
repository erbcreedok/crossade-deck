...
test.describe("песочница — дропзона ПОДГЛЯДЕТЬ", () => {
  ...
  // Решение владельца: показ — ВСЕГДА временный. Перехватить раскрытую карту повторным драгом
  // можно, но «выиграть» ею скрытность нельзя: по концу драга карта возвращается в исходный вид
  // сама. Тест раньше ждал обратного («флаг потерян навсегда») и падал с чистого main — ждал
