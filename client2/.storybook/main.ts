...
const config: StorybookConfig = {
  ...
  // Docs включены (tags: ["autodocs"] в preview.tsx), но со СВОЕЙ страницей — .storybook/DocsPage.tsx.
  // Штатная заканчивается блоком <Stories/>, который монтирует каждую стори раздела живым канвасом;
  // у нас канвас ОДИН на весь сторибук (пул витрин), и такой странице он не по карману. Наша
  // показывает один живой пример и ИСХОДНИКИ всех стори — ровно то, зачем доки и понадобились.
