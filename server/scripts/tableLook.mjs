...
check("шестерёнка открывает окно: три выключателя звука, объёмный, меньше анимаций, 4 цвета, кириллица (вибрации и полного экрана в браузере нет)", (await A.$$("[data-settings-panel] [data-look]")).length === 7);
