...
export interface TableStore {
  ...
  /**
   * ЧТО УЖЕ СЛУЧИЛОСЬ ДО МОЕГО ПРИХОДА — с временем каждого события, прорезанное сервером под меня.
   *
   * Журнал живёт на экране, и без этого обновление страницы стирало партию: поток операций
