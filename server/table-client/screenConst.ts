...
/** Двойной тап: второй тап не позже этого после первого. */
export const DOUBLE_TAP_MS = 320;
/**
 * Двойной тап целится в ТОЧКУ, а не в карту. Первый тап поднимает карту, веер под пальцем едет, и
 * второй тап садится уже на соседнюю — а человек всё это время держал палец на месте и ждал
 * переворота. Пока пара сверялась по имени карты, в тесной руке она не складывалась почти никогда.
 * Палец толще карты: порог шире, чем `TAP_PX`, иначе половина пар распадётся на ровном месте.
 */
