...
/** Пропуск на запись партии: комната и до каких пор. Адрес собирает экран. */
...
export const MSG = {
  ...
  command: "command",
  /**
   * ЗАПИСЬ ПАРТИИ: клиент → сервер пустое, сервер → ему же `Recording` — пропуск на эту комнату.
   *
   * Пропуск живёт сам по себе и открывает одну запись: его можно переслать, не отдавая ключ от
   * комнат. Сам адрес собирает экран: он уже открыт по тому адресу, по которому стол виден снаружи,
