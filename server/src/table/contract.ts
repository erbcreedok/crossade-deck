...
export interface DeckSpot {
  ...
  name?: string;
  /**
   * МЕСТ В КОЛЬЦЕ — НЕ МЕНЬШЕ И НЕ БОЛЬШЕ. Только для позы `ring`.
   *
   * Числа, а не правила, и меняются на ходу: в партии обоими станет число играющих — чтобы круг
   * держал форму с первой карты и чтобы седьмая не легла при шести игроках. Не заданы — три и
   * сколько угодно.
   */
  least?: number;
  most?: number;
