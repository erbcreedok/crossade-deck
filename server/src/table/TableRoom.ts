...
/**
 * СКОЛЬКО СЛУЧИВШЕГОСЯ КОМНАТА ДЕРЖИТ ДЛЯ ВОШЕДШЕГО.
 *
 * Не «сколько влезет», а сколько человек успеет прочесть. Двести событий весили сто двадцать
 * килобайт и ехали в КАЖДОМ приветствии: вход стал тяжёлым, а на телефоне со слабой связью тяжёлый
 * вход сам рвёт соединение — и следующий вход снова тянет те же сто двадцать. За одну живую партию
 * это дало девять обрывов у одного игрока и ни одного у другого.
 */
